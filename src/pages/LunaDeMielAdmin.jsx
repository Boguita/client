...
const LunaDeMielAdmin = () => {
  ...
  const approvedUsers = beneficios?.filter(
    (beneficio) => beneficio.estado === "Entregado"
  );
  const rejectedUsers = beneficios?.filter(
    (beneficio) => beneficio.estado === "Rechazado"
  );
  const pendingUsers = beneficios?.filter(
    (beneficio) => beneficio.estado === "Entregado"
  );
