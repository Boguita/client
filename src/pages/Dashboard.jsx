...
//               <div className="flex items-center mt-4">
//             <IoIosAddCircle className='text-cyan-800 text-3xl mr-2' />
//             <Link to="/solicitar-beneficio" className="text-[#006084] font-semibold">ESCANEAR CREDENCIAL DIGITAL</Link>
            
//           </div>
//              <div className="flex items-center mt-4">
//             <IoIosAddCircle className='text-[#006084] text-3xl mr-2' />
//             <Link to="/solicitar-beneficio" className="text-[#006084] font-semibold">INGRESAR DNI MANUALMENTE</Link>
//           </div>
//             </div>
...
//           <div className='flex flex-col mt-10 pl-20'>
