  ...
  <div className="mt-4 flex justify-center items-center">
   ...
   <table   className="min-w-full mt-3 divide-y-4 divide-[#006084]">
    ...
    typeof selectedUser.dni_img_frente === 'string' && (
      <a
        href={`http://backuatrebeneficios.galgoproductora.com/${selectedUser.dni_img_frente}`}
        target="_blank"
    ...
    typeof selectedUser.dni_img_dorso === 'string' && (
      <a
        href={`http://backuatrebeneficios.galgoproductora.com/${selectedUser.dni_img_dorso}`}
        target="_blank"
        rel="noopener noreferrer"
      >
        <span className='text-xs underline'>Dorso</span>
                  ...
                  <td className="px-6 py-3 whitespace-no-wrap">{selectedUser.usuario_otorgante}</td>
                                          ...
                                          <div className='flex  items-center justify-around '>
                                            <a href={`http://backuatrebeneficios.galgoproductora.com/${selectedUser.constancia_img}`}  target="_blank"
