...
import { crearSeccional, editarSeccional } from "./ServiceSeccionales";
import { loadSeccionales } from "../../../store/seccionales";

const FichaCrearSeccional = (props) => {
...
// }
  ...
  // }
    await crearSeccional(formData);
    swal({
      title: "Éxito!",
      text: `La seccional ha sido creada con éxito.`,
      icon: "success",
    });
...
export default FichaCrearSeccional;
