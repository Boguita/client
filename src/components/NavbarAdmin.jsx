...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 left-0 w-full z-40  px-4 py-2 bg-[#006084] text-white ${
          fix ? "shadow-md" : ""
        }`}
      >
      ...
      <aside
        id="logo-sidebar"
        className="fixed justify-center z-50 left-0 top-0  w-30 lg:w-72 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-cover bg-center bg-[51rem]"
        ...
        <div className="flex flex-col space-y-2 h-screen px-3 py-4 overflow-y-auto relative bg-black bg-opacity-80">
          <div className="h-full w-full">
            ...
            >
              <img
                src={Logo}
                className="h-full mt-6 mb-6 mr-3 sm:h-full w-full "
                alt="UATRE Logo"
              />
            </Link>
            <ul className="space-y-5 font-medium ">
              <li>
                <Link
                  to="/admin/dashboard"
                  className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-700"
                >
              ...
              <li>
                ...
                >
                  ...
                  <span
                    className={`ml-3 ${
                      location.pathname === "/admin/registro-afiliado"
                        ? "text-blue-500"
                        : "text-white"
                    }`}
                  >
              ...
              <li>
                <Link
                  to="/admin/luna-de-miel"
                  className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-700"
                >
                  <img
                    src={Plane}
                    className="flex-shrink-0 w-6 h-6 text-white transition duration-75 dark:text-white group-hover:text-gray-900 dark:group-hover:text-white"
                  />
                  <span
                    className={`ml-3 ${
                      location.pathname === "/admin/luna-de-miel"
                        ? "text-blue-500"
                        : "text-white"
                    }`}
                  >
              ...
              <li>
                ...
                >
                  ...
                  <span
                    className={`ml-3 ${
                      location.pathname === "/admin/kit-nacimiento"
                        ? "text-blue-500"
                        : "text-white"
                    }`}
                  >
              ...
              <li>
                ...
                >
                  ...
                  <span
                    className={`ml-3 ${
                      location.pathname === "/admin/kit-escolar"
                        ? "text-blue-500"
                        : "text-white"
                    }`}
                  >
              ...
              <li>
                ...
                >
                  ...
                  <span
                    className={`ml-3 ${
                      location.pathname === "/admin/seccionales"
                        ? "text-blue-500"
                        : "text-white"
                    }`}
                  >
              ...
              <li>
                <Link to="/admin/login">
                  <span
                    ...
                    className="cursor-pointer flex items-center p-2  rounded-lg text-white hover:bg-gray-700"
                  >
                    <svg
                      aria-hidden="true"
                      className="flex-shrink-0 w-6 h-6 text-white transition duration-75 dark:text-white group-hover:text-gray-900 dark:group-hover:text-white"
