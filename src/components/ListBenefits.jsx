                ...
                <tr  key={index} className={`text-gray-600 text-sm font-semibold ${index % 2 === 0 ? grayRowClass : whiteRowClass }`}>
                              ...
                              <td className="px-2  py-3 whitespace-no-wrap">{row.seccional}</td>
                               <td className="px-2  py-3 whitespace-no-wrap">{row.delegacion}</td>
                                ...
                                <td className={`px-2 2xl:px-6 capitalize py-3 whitespace-no-wrap`}><span className={`bg-opacity-30 rounded-lg px-2 p-1 ${row.utiles_Jardín < 10 ? 'bg-red-400 text-red-500' : row.utiles_Jardín >= 10 && row.utiles_Jardín <= 50 ? 'bg-yellow-400 text-yellow-500' : 'bg-green-400 text-green-500'}`}>{row.utiles_Jardín}</span></td>
