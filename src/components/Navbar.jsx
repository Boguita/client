    ...
    >
      ...
      <div className="h-full w-full ">
       <Link onClick={() => setFix(!fix)}  to="/homeInfo" className={`flex items-center p-2 rounded-lg dark:text-white   ${
        ...
        <li>
          <Link onClick={() => setFix(!fix)} to="/ayuda" className={`flex items-center p-2 text-gray-900 ${location.pathname === '/ayuda' ? 'text-blue-500' : 'text-white'} rounded-lg dark:text-white hover:bg-gray-700`}>
            <MdHelp className="text-2xl"/>
            <span className={`ml-3 ${location.pathname === '/ayuda' ? 'text-blue-500' : 'text-white'}`}>Ayuda</span>
          </Link>
        </li>
        <li>
          <Link onClick={() => setFix(!fix)} to="/soporte" className={`flex items-center p-2 text-gray-900 ${location.pathname === '/soporte' ? 'text-blue-500' : 'text-white'} rounded-lg dark:text-white hover:bg-gray-700`}>
        ...
        <li>
          <Link>
            <span onClick={handleLogout} className="cursor-pointer flex items-center p-2  rounded-lg text-white hover:bg-gray-700">
